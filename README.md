...
- **Управление метками** (`labels`) — просмотр и интерактивное редактирование меток проекта (добавление, переименование, удаление); перед удалением проверяет количество аннотаций и требует подтверждения
...
Просмотр и интерактивное редактирование меток (labels) проекта CVAT. Поддерживает добавление, переименование и удаление меток. Перед удалением подсчитывает количество аннотаций, использующих метку, и требует явного подтверждения.
...
# Интерактивное редактирование (добавление/переименование/удаление)
